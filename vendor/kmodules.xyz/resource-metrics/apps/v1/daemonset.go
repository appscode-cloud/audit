...
func init() {
	api.Register(apps.SchemeGroupVersion.WithKind("DaemonSet"), DaemonSet{}.ResourceCalculator())
}

type DaemonSet struct{}

func (r DaemonSet) ResourceCalculator() api.ResourceCalculator {
...
func (DaemonSet) roleReplicasFn(obj map[string]any) (api.ReplicaList, error) {
	return nil, nil
}

func (r DaemonSet) roleResourceFn(fn func(rr core.ResourceRequirements) core.ResourceList) func(obj map[string]any) (map[api.PodRole]api.PodInfo, error) {
