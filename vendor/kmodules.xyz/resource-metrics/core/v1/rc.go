...
func init() {
	api.Register(core.SchemeGroupVersion.WithKind("ReplicationController"), ReplicationController{}.ResourceCalculator())
}

type ReplicationController struct{}

func (r ReplicationController) ResourceCalculator() api.ResourceCalculator {
...
func (ReplicationController) roleReplicasFn(obj map[string]any) (api.ReplicaList, error) {
...
func (r ReplicationController) roleResourceFn(fn func(rr core.ResourceRequirements) core.ResourceList) func(obj map[string]any) (map[api.PodRole]api.PodInfo, error) {
	return func(obj map[string]any) (map[api.PodRole]api.PodInfo, error) {
		...
		container, err := api.AggregateContainerResources(obj, fn, api.AddResourceList, "spec", "template", "spec", "containers")
		if err != nil {
			return nil, err
		}
