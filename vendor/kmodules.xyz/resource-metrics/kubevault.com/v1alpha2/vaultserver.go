...
func (r VaultServer) roleReplicasFn(obj map[string]any) (api.ReplicaList, error) {
...
func (r VaultServer) modeFn(obj map[string]any) (string, error) {
	return VaultModeDefault, nil
}

func (r VaultServer) usesTLSFn(obj map[string]any) (bool, error) {
	_, found, err := unstructured.NestedFieldNoCopy(obj, "spec", "tls")
	return found, err
}

func (r VaultServer) roleResourceFn(fn func(rr core.ResourceRequirements) core.ResourceList) func(obj map[string]any) (map[api.PodRole]api.PodInfo, error) {
